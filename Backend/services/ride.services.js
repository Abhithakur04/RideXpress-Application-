...
async function getFare(pickup, destination) {
    ...
    // ---> distanceTime.distance in meters so convert in kms &&  distanceTime.duration in seconds so covert in minutes
...
module.exports.confirmRide = async ({
   ...
   // when user confirm the ride then it send request to ride route now ride is created and we update the rid edocument that is status and capatin id and in ride document instaed of user id and captai id we put their full detail
