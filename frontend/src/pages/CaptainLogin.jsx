...
const CaptainLogin = () => {
 ...
 className="bg-[#eeeeee] mb-7 rounded px-4 py-2 border w-full text-lg placeholder:text-base"
  ...
  <div>
    <Link to='/login' className="bg-[#d5622d] flex items-center justify-center text-white font-semibold mb-9 rounded px-4 py-2  w-full text-lg">Sign in as User</Link>
  </div>
</div>
  )
}
